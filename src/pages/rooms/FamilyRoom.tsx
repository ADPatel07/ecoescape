            ...
            <div className="grid grid-rows-2 gap-4">
              ...
              <div className="bg-primary/10 rounded-2xl flex items-center justify-center">
                <div className="text-center p-6">
                  ...
                  <p className="text-foreground font-semibold mb-1">Perfect for Families</p>
                  <p className="text-sm text-muted-foreground">2 Bedrooms + Dining</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex items-center gap-1 text-sm text-amber-600">
                ...
                <span className="text-muted-foreground">(86 reviews)</span>
              </div>
            </div>
